...
namespace SalesWebMvc3.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            /*Saller s1 = new Saller(1, "bob brow", "bob@gmail.com", new DateTime(1998, 4, 21), 1000.0, d1);
            Saller s2 = new Saller(1, "maria Green", "maria@gmail.com", new DateTime(1979, 12, 31), 1000.0, d2);
            Saller s3 = new Saller(1, "Alex Grey", "bob@gmail.com", new DateTime(1998, 1, 15), 4000.0, d1);
            Saller s4 = new Saller(1, "Martha Red", "bob@gmail.com", new DateTime(1993, 11, 30), 2500.0, d4);
            Saller s5 = new Saller(1, "Donald Blue", "bob@gmail.com", new DateTime(2000, 1, 9), 3800.0, d3);
            Saller s6 = new Saller(1, "Alex Pink", "bob@gmail.com", new DateTime(1997, 3, 4), 9000.0, d2);*/

            Saller s1 = new Saller(1, "bob brow", "bob@gmail.com", new DateTime(1998, 4, 21), 1000.0, d1);
            Saller s2 = new Saller(2, "maria Green", "maria@gmail.com", new DateTime(1979, 12, 31), 1000.0, d2);
            Saller s3 = new Saller(3, "Alex Grey", "alex@gmail.com", new DateTime(1998, 1, 15), 4000.0, d1);
            Saller s4 = new Saller(4, "Martha Red", "martha@gmail.com", new DateTime(1993, 11, 30), 2500.0, d4);
            Saller s5 = new Saller(5, "Donald Blue", "donald@gmail.com", new DateTime(2000, 1, 9), 3800.0, d3);
            Saller s6 = new Saller(6, "Alex Pink", "alexpink@gmail.com", new DateTime(1997, 3, 4), 9000.0, d2);
            ...
            _context.Saller.AddRange(s2, s2, s3, s4, s5, s6);
